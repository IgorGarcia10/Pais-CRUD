                    ...
                    <form action="ManterPaisController.do" method="post">
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="area" class="form-control" name="area" id="area" maxlength="15" pattern="(?:\(\d{2}\)|\d{2})[- ]?\d{5}[- ]?\d{4}" placeholder="area" value="${pais.area}">
                            </div>

                            <div class="form-group col-md-6">
                                <label for="Populacao"></label>
                                <input type="populacao" class="form-control" name="populacao" id="populacao" required maxlength="60" placeholder="populacao obrigatório" value="${pais.populacao }">
                            </div>
                        </div>
                        <hr />
