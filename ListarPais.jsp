                            ...
                            <tbody>
          					<c:forEach var="pais" items="${lista }">
                                       <tr>
                                            ...
                                            <td class="actions">
                                                <a class="btn btn-success btn-xs" href="ManterPaisController.do?acao=Visualizar&id=${pais.id }">Visualizar</a>
                                                <a class="btn btn-warning btn-xs" href="ManterPaisController.do?acao=Editar&id=${pais.id }">Editar</a>
